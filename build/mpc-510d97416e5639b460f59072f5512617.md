...
exec(open('code/hypnosis_control_nmpc.py').read())
```
...
exec(open('_static/do_mpc_batch_bioreactor.py').read())
```
...
exec(open('_static/do_mpc_batch_bioreactor_animated.py').read())
``` -->