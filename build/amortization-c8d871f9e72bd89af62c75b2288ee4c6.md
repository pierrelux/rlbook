...
In all these examples, the stock dynamics are affine in $(y,c)$, which makes the Euler-class condition automatic. The class of Euler-type methods therefore applies well beyond textbook macro models, as long as one is willing to work with such coarse stock dynamics.
