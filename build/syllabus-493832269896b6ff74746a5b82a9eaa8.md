...
| 5 · Sep 28 – Oct 1 | Adjoints and the Pontryagin principle; single and multiple shooting; MPPI and stochastic trajectory optimization | [Discrete-Time PMP](discrete-time-pmp.md), [Numerical Trajectory Optimization](numerical-trajectory-optimization.md) |
...
| 5 · 28 sept. – 1<sup>er</sup> oct. | États adjoints et principe de Pontryagin ; tir simple et tir multiple ; MPPI et optimisation stochastique de trajectoires | [Discrete-Time PMP](discrete-time-pmp.md), [Numerical Trajectory Optimization](numerical-trajectory-optimization.md) |
