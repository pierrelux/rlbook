...
These choices are independent but should be coordinated. Using high-order Chebyshev polynomials with crude rectangle-rule integration wastes the approximation power of the basis. Standard pairings include:
...
The quadrature should be accurate enough that integration error does not dominate projection error.
