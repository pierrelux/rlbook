...
This is the least-squares approach from the [projection methods chapter](projection.md). SAC computes targets $y_i$ and fits to them (successive approximation). PCL directly minimizes the residual without computing targets or performing a separate fitting step.
