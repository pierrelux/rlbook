...
| service simulation | 0.1-second steps; one phase per step; prefill chunks capped at 512 tokens |
...
or one prefill chunk at each 0.1-second simulator step. When both phases have
