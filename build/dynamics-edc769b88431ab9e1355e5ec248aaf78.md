...
drives toward the largest capacity-normalized deficit. If it is empty, and
both a deficit and a surplus of at least two remain, it drives toward the
largest capacity-normalized surplus. Distance breaks ties. Finally, when the
