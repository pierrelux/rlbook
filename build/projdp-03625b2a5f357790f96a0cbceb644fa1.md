...
The most common approach is the **projection framework**, where we select $n$ test functions $\{p_1, \ldots, p_n\}$ and require the residual to be orthogonal to each:
...
We focus primarily on projection methods, distinguished entirely by their choice of test functions $p_i$.
