...
### Why the Bias Persists Under Iteration
...
This upward bias is not just a theoretical curiosity. It is the same phenomenon that appears in many reinforcement learning algorithms that bootstrap and maximize over noisy value estimates, and it motivates a whole family of variance-reduction and "double" methods that we will encounter later in the chapter.
