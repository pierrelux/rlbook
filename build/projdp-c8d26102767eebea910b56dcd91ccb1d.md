...
These $n$ integral conditions provide $n$ equations to determine the $n$ unknown coefficients in $\theta$. Different choices of test functions $p_i$ give different methods. The most common approach uses the **projection framework**: select $n$ test functions $\{p_1, \ldots, p_n\}$ and require:
