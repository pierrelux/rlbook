...
3.91 seconds, at 2,347.9 joules. The unchanged offline plan uses 2,209.1 joules
but raises that latency to 6.75 seconds. MPC lies between them at 4.11 seconds
...
accepts 58 solves and invokes the recorded fallback twice; every accepted solve
meets the 0.8-second deadline. Thus no controller
...
unfinished work. Together, these quantities
