...
Define the **Euler residual operator** $\EulerResidual$ by
...
that is, $\EulerResidual(\pi)$ is the left-hand side of the Euler equation evaluated at the policy $\pi$. The optimal policy $\pi^*$ satisfies
