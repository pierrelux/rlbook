...
The KL constraint ensures that the two distributions remain similar, which bounds how extreme the importance weights can become. However, this constrained optimization problem requires computing second-order information (the Fisher information matrix) and solving a trust region subproblem at each iteration, which is computationally expensive.
