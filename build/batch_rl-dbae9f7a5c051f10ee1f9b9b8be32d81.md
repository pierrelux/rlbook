...
Bias correction and soft maximum operators both modify targets while keeping the loss function fixed. An alternative approach changes the loss function itself.
