...
```{prf:proof}
Since $\mathrm{L}$ is a $\gamma$-contraction, we have $-\gamma\|f-g\|_\infty \leq \Bellman f - \mathrm{L} g \leq \gamma\|f-g\|_\infty$ pointwise. By monotonicity of $\Proj$, $\Proj(-\gamma\|f-g\|_\infty) \leq \Proj(\Bellman f - \mathrm{L} g) \leq \Proj(\gamma\|f-g\|_\infty)$. By constant preservation, $-\gamma\|f-g\|_\infty \leq \Proj(\Bellman f - \mathrm{L} g) \leq \gamma\|f-g\|_\infty$, which implies $\|\Proj \Bellman f - \Proj \mathrm{L} g\|_\infty \leq \gamma\|f-g\|_\infty$.
