...
contains the coefficient generator and NLP residual evaluator. The excerpt
below computes $A,b,B$ by polynomial arithmetic for any distinct collocation
and control support nodes:
