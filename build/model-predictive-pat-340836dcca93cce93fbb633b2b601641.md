...
The sampling mean is the entire nominal sequence $\mathbf U$: changing
its entry $\mathbf u_k$ moves the center of the candidate controls at step
$k$. Initializing $\mathbf U=\mathbf0$ means setting every
...
weight and normalizing. Its covariance at each step remains $\Sigma$. It can therefore
