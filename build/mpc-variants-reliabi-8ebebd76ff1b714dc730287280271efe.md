...
Fresh evaluation still needs power forecasts available when the controller
acts. The selected model remains unaccepted for online advisory forecasts or
hard thermal constraints; measured-temperature watchdogs operate independently.
