...
Using the chain rule to differentiate $g(s,a)$ with respect to $a$:

$$
\frac{\partial g}{\partial a}(s,a) = \frac{\partial r}{\partial a}(s,a) + \gamma \sum_{\ell=1}^d \frac{\partial v^*}{\partial s_\ell}(f(s,a)) \frac{\partial f_\ell}{\partial a}(s,a)
$$

Evaluating at the optimal action $a^* = \pi^*(s)$ and setting to zero yields the Euler equation:
