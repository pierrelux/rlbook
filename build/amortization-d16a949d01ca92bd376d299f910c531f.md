...
4. Initialize exploration noise process $\eta$
5. $n \leftarrow 0$

6. **while** training:
    1. Observe current state $s$
    2. Select action with noise: $a = \pi_{\boldsymbol{w}_n}(s) + \eta_t$
