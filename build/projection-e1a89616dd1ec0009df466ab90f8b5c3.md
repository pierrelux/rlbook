...
The connection to **Fitted Q-Iteration (FQI)** is now immediate. Taking $f = \Bellman \hat{v}_k$ (the Bellman image of the current iterate), orthogonal projection gives:
