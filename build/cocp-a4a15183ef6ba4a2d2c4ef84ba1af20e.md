...
```{code-cell} ipython3
:tags: [hide-input]
:label: fig-collocation-illustration

exec(open('_static/collocation_illustration.py').read())
```
...
exec(open('code/compressor_surge_single_shooting.py').read())
```
...
exec(open('code/compressor_surge_trapezoidal_collocation.py').read())
```
...
exec(open('code/compressor_surge_data_collection.py').read())
```

```{code-cell} ipython3
:tags: [hide-input]

exec(open('code/compressor_surge_direct_single_shooting_rk4_paramid.py').read())
```
...
exec(open("_static/hydro.py").read())
