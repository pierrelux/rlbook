...
<section id="__ROOT__" class="battery-replay" tabindex="0" aria-labelledby="__TITLE_ID__" aria-describedby="__DESCRIPTION_ID__">
  <style>
    ...
    #__ROOT__ output, #__ROOT__ .number { font-family:"IBM Plex Mono",ui-monospace,monospace; font-variant-numeric:tabular-nums; }
    #__ROOT__ output { font-size:.8rem; min-width:5.7rem; }
  ...
  <div class="toolbar">
    <div class="transport">
      ...
      <output data-time>0.0 min</output>
    </div>
  ...
  (() => {
    ...
    const render = () => {
      ...
      scrubber.value=String(frameIndex); timeOutput.value=`${(frame.time_s/60).toFixed(1)} min`;
