...
{cite:p}`Williams2017InformationTheoretic`. In the continuous-time
path-integral derivation, the reference law is generated by an uncontrolled
...
The [Brownian examples](model-predictive-path-integral-control.md#sec-brownian-passages)
compare this calculation with analytic and numerical reference solutions;
the aircraft example additionally estimates expected costs across possible
wind futures.
