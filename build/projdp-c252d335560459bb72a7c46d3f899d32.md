...
To eliminate $v^*$, apply the envelope theorem. For deterministic dynamics $s' = f(s,a)$ where $v^*(s)$ is differentiable, the FOC becomes:

$$
\frac{\partial r}{\partial a}\big(s,\pi^*(s)\big) + \gamma \frac{\partial f}{\partial a}\big(s,\pi^*(s)\big)^\top \frac{\partial v^*}{\partial s}\big(f(s,\pi^*(s))\big) = 0.
\tag{Euler}
$$
...
$$
\frac{\partial v^*}{\partial s}(s) = \frac{\partial r}{\partial s}\big(s,\pi^*(s)\big) + \gamma \frac{\partial f}{\partial s}\big(s,\pi^*(s)\big)^\top \frac{\partial v^*}{\partial s}\big(f(s,\pi^*(s))\big).
$$
