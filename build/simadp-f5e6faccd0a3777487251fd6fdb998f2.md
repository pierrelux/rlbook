...
**Training the correction model.** The procedure has two phases. First, we perform a high-cost simulation pass at a subset of states to estimate the bias. Second, we fit a regression model to predict the bias from features.
