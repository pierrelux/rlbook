...
however, we cannot calculate $Z$ or $\mathbb E_{P^\star}[\mathbf v_k]$
analytically, nor draw samples directly from $P^\star$.
...
operations even though we cannot sample directly from $P^\star$ or
evaluate its normalizing constant $Z$ analytically.
