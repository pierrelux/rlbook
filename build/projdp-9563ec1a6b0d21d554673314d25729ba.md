...
```{prf:proof}
By {prf:ref}`monotone-nonexpansive`, $\Proj$ is nonexpansive since it satisfies monotonicity and constant preservation. Since $\Bellman$ is a $\gamma$-contraction, we have $\|\mathrm{L} f - \mathrm{L} g\|_\infty \leq \gamma\|f-g\|_\infty$. Therefore:
