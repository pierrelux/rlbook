...
exec(open('code/euler_step_size_viz.py').read())
```
...
exec(open('code/euler_integral_approximation_viz.py').read())
```
...
exec(open('code/trapezoid_integral_approximation_viz.py').read())
```
...
exec(open('code/predictor_corrector_trapezoid_viz.py').read())
```
...
exec(open('code/collocation_ivp_demo.py').read())
```
