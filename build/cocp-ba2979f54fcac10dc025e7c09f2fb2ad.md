...
%run code/compressor_surge_single_shooting.py
```
...
%run code/compressor_surge_trapezoidal_collocation.py
```
...
%run code/compressor_surge_data_collection.py
```

```{code-cell} ipython3
:tags: [hide-input]

%run code/compressor_surge_direct_single_shooting_rk4_paramid.py
```
