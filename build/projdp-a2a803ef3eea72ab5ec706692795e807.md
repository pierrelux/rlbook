...
**The stationary distribution condition.** Suppose $\xi$ is the steady-state distribution: $\xi^\top \mathbf{P}_\pi = \xi^\top$. We want to show that $\mathbf{P}_\pi$ is non-expansive in $\|\cdot\|_\xi$, meaning $\|\mathbf{P}_\pi z\|_\xi \leq \|z\|_\xi$ for any vector $z$. 
