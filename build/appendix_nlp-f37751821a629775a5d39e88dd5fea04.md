...
=\inf_{\mathbf x}\mathcal L(\mathbf x,\boldsymbol\mu,\boldsymbol\lambda).
$$
...
$$
q(\boldsymbol\mu,\boldsymbol\lambda)
\le\mathcal L(\bar{\mathbf x},\boldsymbol\mu,\boldsymbol\lambda)
\le f(\bar{\mathbf x}).
$$
...
$$
\mathcal L(\mathbf x^\star,\boldsymbol\mu,\boldsymbol\lambda)
\le
\mathcal L(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)
\le
\mathcal L(\mathbf x,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)
$$
...
A point $(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)$
satisfies the KKT conditions when

$$
\begin{aligned}
\nabla_{\mathbf x}\mathcal L(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)
...
$$
\mathcal L(\mathbf x,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)
\ge \mathcal L(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)
+\nabla_{\mathbf x}\mathcal L(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)^\top
...
$\mathcal L(\mathbf x^\star,\boldsymbol\mu,\boldsymbol\lambda)\le f(\mathbf x^\star)$,
while complementary slackness gives
$\mathcal L(\mathbf x^\star,\boldsymbol\mu^\star,\boldsymbol\lambda^\star)=f(\mathbf x^\star)$.
...
**Output:** Final primal and multiplier iterates $\mathbf{x}^k$, $\boldsymbol{\lambda}^k$, $\boldsymbol{\mu}^*$
