...
exec(open('code/nlp_geometry.py').read())
```
...
```{code-cell} ipython3
exec(open('code/kkt_lagrangian_verif.py').read())
```
...
exec(open('code/ecp_newton.py').read())
```
...
exec(open('code/sqp_ineq_cvxpy_jax.py').read())
```
...
exec(open('code/arrow_hurwicz_uzawa_jax.py').read())
```
