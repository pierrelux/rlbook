...
The [MPPI development](numerical-trajectory-optimization.md#sec-mppi) constructs
...
The [Brownian examples](numerical-trajectory-optimization.md#sec-brownian-passages)
