...
%run code/euler_step_size_viz.py
```
...
%run code/euler_integral_approximation_viz.py
```
...
%run code/trapezoid_integral_approximation_viz.py
```
...
%run code/predictor_corrector_trapezoid_viz.py
```
...
%run code/collocation_ivp_demo.py
```
