...
The same trajectory weight multiplies every action in its sequence. The
update combines the candidate control sequences, giving more influence to
those with larger weights.
...
nonzero control sequence also requires an importance correction to the weights, derived
