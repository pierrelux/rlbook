...
The [next chapter](pg.md) takes a different approach: parameterize the policy directly and optimize via gradient ascent on expected return. This removes the Q-function scaffolding while introducing new challenges in gradient estimation.
