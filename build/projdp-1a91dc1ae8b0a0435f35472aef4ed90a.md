...
Judd {cite}`Judd1992` uses this approach for economic growth models with Chebyshev polynomial bases and Gauss-Chebyshev quadrature to approximate the integrals.
...
The first-order conditions yield orthogonality conditions with test functions $\frac{\partial \mathcal{R}_E(\pi_{\boldsymbol{\theta}})}{\partial \theta_i}$.
