...
The [path-integral control derivation](model-predictive-path-integral-control.md#sec-path-integral-control)
uses these Brownian moments to develop the particular value equation and
forward expectation needed for MPPI.
