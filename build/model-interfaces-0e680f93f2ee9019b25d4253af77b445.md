...
The recorded L4 profile shows why a service map must retain concurrency. At a
requested 2,040 MHz with a 1,024-token prompt, aggregate decode throughput rises
...
Each point is the median of five concurrent batches; whiskers show their minimum
...
fresh requests. These batch measurements initialize its model; the replay below
retains the original reduced teaching model.
