...
We have developed weighted residual methods through abstract functional equations: choose test functions, impose orthogonality conditions $\langle R, p_i \rangle_w = 0$, solve for coefficients. But what are we actually computing? The answer is simpler than the formalism suggests: **successive approximation with a fitting step**.
