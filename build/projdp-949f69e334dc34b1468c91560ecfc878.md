...
```{prf:proof}
By {prf:ref}`monotone-nonexpansive`, $\Proj$ is nonexpansive since it satisfies monotonicity and constant preservation. Since $\Bellman$ is a $\gamma$-contraction, we have $\|\Bellman f - \mathrm{L} g\|_\infty \leq \gamma\|f-g\|_\infty$. Therefore:

$$
\|\Proj \mathrm{L} f - \Proj \mathrm{L} g\|_\infty \leq \|\Bellman f - \mathrm{L} g\|_\infty \leq \gamma\|f-g\|_\infty,
$$
