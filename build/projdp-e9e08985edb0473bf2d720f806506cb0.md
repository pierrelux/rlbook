...
$$
\frac{\partial Q^*(s, a)}{\partial a}\Big|_{a=a^*} = \frac{\partial r(s, a)}{\partial a}\Big|_{a=a^*} + \gamma \sum_{j \in \mathcal{S}} \frac{\partial p(j|s,a)}{\partial a}\Big|_{a=a^*} v^*(j) = 0.
$$
