...
|:-----------|:-------------------|:------------------------|
| Minimum residual | $p_j = \frac{\partial R(\cdot; \theta)}{\partial \theta_j}$ | $\displaystyle\min_\theta \tfrac{1}{2}\|R(\cdot; \theta)\|_w^2$ |
| Galerkin | $p_j = \varphi_j$ | $\displaystyle\min_\theta \|R(\cdot; \theta)\|_{\mathcal{V}^*}$ (dual norm) |
| Collocation | $p_j = \delta(s - s_j)$ | $\displaystyle\min_\theta \sum_j \omega_j R(s_j; \theta)^2$ |
| Petrov–Galerkin | $p_j \neq \varphi_j$ | $\displaystyle\min_\theta \|R(\cdot; \theta)\|_{W}^2$ (custom metric $W$) |
