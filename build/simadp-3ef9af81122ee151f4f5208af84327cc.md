...
The idea is to approximate both the value function and the bias function using parametric forms. Suppose we approximate the value function as
...
The regression at line 15 requires some explanation. We observe noisy targets $y_m = (\widehat{\Bellman}_N v_k)(s_m)$, which we know are biased estimators of $(\Bellman v_k)(s_m)$. We model this as
